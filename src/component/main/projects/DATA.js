const projects = [
    ...
    },
    {
        ...
        description: (
            <>
                <p>
                    Rest Tester is an innovative web application that allows
                    users to test <b>RESTful APIs</b> with ease and efficiency.
                    The platform is designed to be intuitive and user-friendly,
                    with a range of features that make it easy to test and
                    modify API requests and responses.
                </p>

                <p>
                    Built using <b>Vanilla JavaScript</b> and <b>Axios</b>, Rest
                    Tester is a lightweight and powerful web application that
                    provides a full-fledged custom code editor for JSON data.
                    This makes it easy for users to create and modify JSON data,
                    and to test their RESTful API requests with precision and
                    accuracy.
                </p>

                <p>
                    One of the key features of Rest Tester is its history
                    record, which is stored in the user's browser storage for
                    easy access and modification. This makes it easy for users
                    to keep track of their API testing history and to make
                    changes and adjustments as needed.
                </p>

                <p>
                    To ensure maximum compatibility and efficiency, Rest Tester
                    is compiled and bundled using Vite, a powerful build tool
                    that provides fast and efficient compilation and bundling
                    for web applications. This ensures that the application runs
                    smoothly and efficiently on a range of different devices and
                    platforms.
                </p>

                <p>
                    Whether you're a developer looking to test your APIs or a
                    user looking to interact with different RESTful services,
                    Rest Tester provides a powerful and flexible platform for
                    testing and debugging your API requests and responses.`,
                </p>
            </>
        ),
        intro: (
            <>
                Rest Tester is an innovative web application that allows users
                to test RESTful APIs with ease and efficiency. The platform is
                designed to be intuitive and user-friendly, with a range of
                features that make it easy to test and modify API requests and
                responses.
            </>
        ),
        ...
        description: (
            <>
                <p>
                    ...
                    intuitive interface for visualizing different search
                    algorithms.
                </p>
                <p>
                    One of the key features of Pathfinding Visualizer is its
                    ability to visualize different search algorithms, including{" "}
                    <b>Dijkstra</b>, <b>A-star</b>, <b>breadth-first search</b>,
                    and <b>depth-first search</b>. This makes it easy for users
                    to see how different search algorithms work and to compare
                    their performance under different conditions.
                </p>
                <p>
                    The user interface of Pathfinding Visualizer is designed to
                    be clear and easy-to-understand visualizations that make it
                    easy to see how the different search algorithms work.
                </p>

                <p>
                    In terms of the tech stack, Pathfinding Visualizer is built
                    using <b>ReactJS</b>, a powerful and flexible front-end
                    framework that provides fast rendering and efficient
                    updates. The app also uses <b>Vanilla CSS</b>, which allows
                    for a high degree of customization and control over the
...

    {
        ...
        description: (
            <>
                <p>
                    MoviePlant is a web application that allows users to search
                    for and view information about movies. The app uses a
                    third-party web API to retrieve a collection of movies based
                    on the user's search query, and then displays this
                    information in an intuitive and user-friendly interface.
                </p>
                <p>
                    One of the key features of MoviePlant is its ability to
                    retrieve movie information asynchronously, providing a fast
                    and responsive user experience. The app is built using{" "}
                    <b>ReactJS</b>, a powerful and flexible front-end framework
                    that provides fast rendering and efficient updates. It also
                    uses <b>Vanilla CSS</b> to provide a high degree of
                    customization and control over the visual appearance of the
                    app.
                </p>
                <p>
                    To use MoviePlant, users simply type in the name of a movie
                    they are interested in to the searchbar, and the app will
                    search for and display information about that movie,
                    including its title, release date, cast, and synopsis. Users
                    can also browse through a collection of popular movies, and
                    filter their search results based on various criteria, such
                    as genre, rating, and release date.
                </p>
            </>
        ),
        intro: (
            <>
                MoviePlant is a web application that allows users to search for
                and view information about movies. The app uses a third-party
                web API to retrieve a collection of movies based on the user's
                search query, and then displays this information in an intuitive
                and user-friendly interface.
            </>
        ),
        githubLink: "https://github.com/medmaha/MoviePlant",
        downloadLink: "",
